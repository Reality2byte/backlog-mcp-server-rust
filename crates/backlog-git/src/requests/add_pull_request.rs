...
use backlog_core::identifier::{AttachmentId, Identifier, IssueId, UserId};
...
impl AddPullRequestParams {
    /// Creates a new AddPullRequestParams with only required fields.
    pub fn new(summary: &str, description: &str, base: &str, branch: &str) -> Self {
        Self {
